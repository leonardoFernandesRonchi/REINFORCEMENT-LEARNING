...
for episode in range(300):
    ...
    while not done:
        ...
        # pow(2) é usado para elevar o erro ao quadrado,

        # e mean() para obter a média.
        ...
        # backward calcula os gradientes do loss em relação

        # aos parâmetros da rede neural

        critic_loss.backward()

        # step atualiza os parâmetros da rede neural
        ...
        actor_loss = (
            ...
            # - inverte o sinal, e log_prob dá a probabilidade

            # logarítmica da ação escolhida

            -dist.log_prob(action)

            # td_error representa o erro temporal do Critic

            # detach -> usa esse valor para calcular o Actor,

            # mas não deixa o gradiente passar por ele até o Critic.
